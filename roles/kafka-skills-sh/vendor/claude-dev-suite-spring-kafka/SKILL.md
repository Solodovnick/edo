<!-- Vendored for EDO Bank `roles/kafka-skills-sh`. Upstream: https://github.com/claude-dev-suite/claude-dev-suite/tree/main/skills/backend-frameworks/spring-kafka — MIT. skills.sh: https://skills.sh/?q=kafka -->
