<!-- Vendored for EDO Bank `roles/kafka-skills-sh`. Upstream: https://github.com/mindrally/skills/tree/main/kafka-development — Apache-2.0 (see upstream LICENSE). Directory listing: https://skills.sh/?q=kafka -->
