<!-- Vendored for EDO Bank `roles/kafka-skills-sh`. Upstream: https://github.com/claude-dev-suite/claude-dev-suite/tree/main/skills/messaging/kafka — MIT. skills.sh: https://skills.sh/?q=kafka -->
