...
| [../external-sources-catalog.md](../external-sources-catalog.md) | **Учёт** ссылок и файлов вне репо (IcePanel, OpenAPI на диске и т.д.); актуализация — задача проектных ролей. |
